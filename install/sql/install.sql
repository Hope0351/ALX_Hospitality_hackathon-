...
INSERT INTO `language` (`id`, `phrase`, `english`, `malay`, `french`, `german`, `spanish`, `turkish`, `hindi`) VALUES (1849, 'vat_tax', 'VAT/TAX', 'VAT/TAX', 'VAT/TAX', 'VAT/TAX', 'VAT/TAX', 'VAT/TAX', 'VAT/TAX');
...
(15, 'Counter Manager', 'Responsible for providing quick and efficient service to customers. Greets customers, takes their food and beverage orders, rings orders into register, and prepares and serves hot and cold drinks.'),
(16, 'Housekeeper', 'Most waiters and waitresses, also called servers, work in full-service restaurants. They greet customers, take food orders, bring food and drinks to the tables and take payment and make change.'),
(17, 'Driver', 'Drive a Specific Vehicle for Pic up & Drop off Customer'),
(18, 'Driver', ' Drive a Specific Vehicle for Pic up & Drop off Customer'),
(19, 'Waiter', 'Restaurant Waiter');
