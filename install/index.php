                                        ...
                                        <h1>Verification</h1>
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a target="_blank" class="btn btn-warning pull-right" href="http://localhost?<?php echo 'product_key='.$Verification->get_product_key().'&'.'purchase_key='.base64_encode(filterInput($_GET['purchase_key']));?>" role="button">Update Purchase Key</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="userid" name="userid" value="weadown" placeholder="User ID" required readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="purchase_key" value="26337c68-3ba4-489d-b417-42f5617fbe10"  name="purchase_key"  placeholder="Purchase Key" required readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
